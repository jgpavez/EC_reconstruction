 ...
 * for a strip, in a layer, in a view, in a sector. Also define the default values
 * for the calibration variables
 *  
...
public class ECCalibrationData implements Serializable
{
	...
	/**
	 * Construct a calibration object for a single strip, layer, view and sector.
